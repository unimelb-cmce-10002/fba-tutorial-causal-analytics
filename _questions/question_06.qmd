...
Instead of only asking who finished (and so summarize behavior into a single final outcome), the manager wants to know where users drop off or loop back inside the process.
