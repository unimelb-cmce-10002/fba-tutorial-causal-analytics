...
Instead of only asking who finished (which summarises behaviour into a single final outcome), the manager wants to know where users drop off or loop back inside the process.
